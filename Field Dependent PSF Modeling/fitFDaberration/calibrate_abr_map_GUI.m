...
%             obj.guihandles.title=uicontrol('style','text','String','Calibrate field dependant aberration from bead stacks. (c) 2022 Li lab, SUSTech','Position',[xpos1,top-vsep,xw*4.5,fieldheight],'FontSize',fontsize-2,'HorizontalAlignment',hatitle,'FontWeight','bold');
            ...
            obj.guihandles.filelist=uicontrol('style','listbox','String','','Position',[xpos1,top-14*vsep,xw*4,vsep*13],'FontSize',fontsize);
            ...
            obj.guihandles.selectfiles=uicontrol('style','pushbutton','String','Select camera files','Position',[xpos1,top-15*vsep,xw*4,vsep],'FontSize',fontsize,'Callback',@obj.selectfiles_callback);
            ...
            obj.guihandles.outputfile=uicontrol('style','edit','String','aber_map.mat','Position',[xpos1,top-17*vsep,xw*4,fieldheight],'FontSize',fontsize);
            obj.guihandles.outputfile.TooltipString='Name of the output file';
            
            
            obj.guihandles.selectoutputfile=uicontrol('style','pushbutton','String','Select output file','Position',[xpos1,top-18*vsep,xw*4,fieldheight],'FontSize',fontsize,'Callback',@obj.selectoutputfile_callback);
            ...
            obj.guihandles.modality=uicontrol('style','popupmenu','String',{'Astigmatic','DMO Tetrapod'},'Value',1,'Position',[xpos1+6.5*xw,top-3*vsep,xw*1.3,fieldheight],'FontSize',fontsize,'Callback',@obj.modality_callback);
            ...
            obj.guihandles.dz=uicontrol('style','edit','String','10','Position',[xpos1+6.5*xw,top-4*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.stdofaberrationst=uicontrol('style','text','String',' Filter factor for outlier beads','Position',[xpos1+4.5*xw,top-8*vsep,xw*2,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.stdofaberrations=uicontrol('style','edit','String','2.5','Position',[xpos1+6.5*xw,top-8*vsep,xw*.5,fieldheight],'FontSize',fontsize);
            
            obj.guihandles.modelrrset=uicontrol('style','text','String','Model rrse','Position',[xpos1+7*xw,top-8*vsep,xw*1,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.modelrrse=uicontrol('style','edit','String','0.15','Position',[xpos1+8*xw,top-8*vsep,xw*.5,fieldheight],'FontSize',fontsize);
            
            obj.guihandles.mapsmootht=uicontrol('style','text','String','Map smooth','Position',[xpos1+4.5*xw,top-9*vsep,xw*2,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.mapsmooth=uicontrol('style','edit','String','200','Position',[xpos1+6.5*xw,top-9*vsep,xw*.5,fieldheight],'FontSize',fontsize);
            
            obj.guihandles.localroit=uicontrol('style','text','String','Local roi','Position',[xpos1+7*xw,top-9*vsep,xw*1,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.localroi=uicontrol('style','edit','String','256','Position',[xpos1+8*xw,top-9*vsep,xw*.5,fieldheight],'FontSize',fontsize);
            
            obj.guihandles.setframest=uicontrol('style','text','String','Frames steps','Position',[xpos1+4.5*xw,top-10*vsep,xw*2,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.setframes=uicontrol('style','checkbox','String','set frames','Position',[xpos1+6.5*xw,top-10*vsep,xw*1,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha,'Callback',@obj.setframes_callback);
            obj.guihandles.framerange=uicontrol('style','edit','String','1:5:201','Position',[xpos1+7.5*xw,top-10*vsep,xw,fieldheight],'FontSize',fontsize,'Visible','off');

            %fit zernike coefficients parameters
            obj.guihandles.zernikefit=uicontrol('style','text','String','Fit zernike parameters: ','Position',[xpos1+4.5*xw,top-11*vsep,xw*2,fieldheight],'FontSize',fontsize,'HorizontalAlignment',hatitle,'FontWeight','bold');  
            obj.guihandles.NAt=uicontrol('style','text','String','Numerical aperture of obj/ NA ','Position',[xpos1+4.5*xw,top-12*vsep,xw*2,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.NA=uicontrol('style','edit','String','1.35','Position',[xpos1+6.5*xw,top-12*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.refmedt=uicontrol('style','text','String','Refractive index of medium ','Position',[xpos1+4.5*xw,top-13*vsep,xw*2,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.refmed=uicontrol('style','edit','String','1.406','Position',[xpos1+6.5*xw,top-13*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.refcovt=uicontrol('style','text','String','Refractive index of converslip ','Position',[xpos1+4.5*xw,top-14*vsep,xw*2,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.refcov=uicontrol('style','edit','String','1.525','Position',[xpos1+6.5*xw,top-14*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.refimmt=uicontrol('style','text','String','Refractive index of immersion oil ','Position',[xpos1+4.5*xw,top-15*vsep,xw*2,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.refimm=uicontrol('style','edit','String','1.406','Position',[xpos1+6.5*xw,top-15*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.lambdat=uicontrol('style','text','String','wavelength of emission ','Position',[xpos1+4.5*xw,top-16*vsep,xw*2,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.lambda=uicontrol('style','edit','String','680','Position',[xpos1+6.5*xw,top-16*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.pixelSizet=uicontrol('style','text','String','Pixel sizeX','Position',[xpos1+7*xw,top-15*vsep,xw*1.,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.pixelSizeX=uicontrol('style','edit','String','108','Position',[xpos1+8*xw,top-15*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.pixelSizet=uicontrol('style','text','String','Pixel sizeY','Position',[xpos1+7*xw,top-16*vsep,xw*1.,fieldheight],'FontSize',fontsize,'HorizontalAlignment',ha);
            obj.guihandles.pixelSizeY=uicontrol('style','edit','String','108','Position',[xpos1+8*xw,top-16*vsep,xw*0.5,fieldheight],'FontSize',fontsize);
            ...
            obj.guihandles.run=uicontrol('style','pushbutton','String','Calculate field dependant aberration maps','Position',[xpos1+4.5*xw,top-18*vsep,xw*4,fieldheight],'FontSize',fontsize,'Callback',@obj.run_callback,'FontWeight','bold');
...
%             if obj.guihandles.zernikefit.Value && obj.zernikepar_flag==0
%                 warndlg('Fit zernike coefficiens parameters is not set and the default parameters will be used.')
%             end
...
%             p.isglobalfit=contains(sm,'global 2 channel')|contains(sm,'4Pi');
            ...
            p.zernikefit.calculatezernike=1;
