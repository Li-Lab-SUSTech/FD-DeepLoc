...
function [imout,shiftedstackn,shifto,indgood,imout_all]=registerPSF3D_g(imin,imint,p,axs,filenumber)
...
imout_all = shiftedstackn(:,:,:,indgood); %add by shiwei 2020/08/14
...
%hard limiter
%start add by shiwei 2020/09/10
% co=a+2.*b;
co=a+5.*b;      % shiwei 设置滤过条件，增加sigma的值可以减少滤掉的点
%end add by shiwei 2020/09/10
